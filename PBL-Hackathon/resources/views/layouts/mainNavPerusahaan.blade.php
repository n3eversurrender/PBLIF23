...
<body>
    ...
    <nav class="bg-white shadow-md border-b border-gray-200 dark:bg-black dark:bg-opacity-50 fixed top-0 left-0 w-full z-10">
        <div class="max-w-screen-2xl grid grid-cols-12 items-center sm:justify-between mx-auto px-2 py-2 sm:px-4 ">
            <a href="#" class="flex sm:col-span-5 items-center space-x-2 rtl:space-x-reverse">
            ...
            <div class="flex  gap-x-3  sm:col-span-7 sm:flex sm:justify-between">
                <div class="items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    ...
                    <button id="dropdownUserAvatarButton" data-dropdown-toggle="dropdownAvatar" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" type="button">
                        ...
                        <img class="w-10 h-10 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src="{{ asset('image/SKILLB.png') }}" alt="user photo" />
                    </button>
                    ...
                    <div id="dropdownAvatar" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <div class="block text-sm text-gray-900 dark:text-white px-4 py-3">
                            <div>PT. Skill Maju</div>
                            <div class="block text-sm text-gray-500 truncate dark:text-gray-400">skillmaju@gmail.com</div>
                        </div>
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownUserAvatarButton">
                            <li>
                                <a href="/statistik" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Kelola Kursus Anda</a>
                            </li>
                        </ul>
                        <div class="py-1">
                            <a href="/Masuk" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Keluar</a>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="flex flex-col font-medium text-sm p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-transparent md:dark:bg-transparent dark:border-gray-700">
                        <li>
                            <a href="/BerandaPerusahaan"
                                class="{{ request()->is('BerandaPerusahaan') ? ' text-blue-600 font-bold' : 'text-gray-500' }} block py-2 px-3 rounded md:border-0 md:p-0 hover:text-black transition duration-700">
                                Beranda
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/ProfilPerusahaan"
                                class="{{ request()->is('ProfilPerusahaan') ? ' text-blue-600 font-bold' : 'text-gray-500' }} block py-2 px-3 rounded md:border-0 md:p-0 hover:text-black transition duration-700">
                                Profil
                            </a>
                        </li>
                    </ul>
