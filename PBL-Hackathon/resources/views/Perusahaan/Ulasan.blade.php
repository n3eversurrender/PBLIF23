    ...
    <table class="min-w-full divide-y divide-gray-200 text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-gray-600">20</td>
                <td class="px-4 py-3 text-gray-600"> <i class="fas fa-star text-yellow-400 text-sm me-2"></i>7.5</td>
                <td class="px-4 py-3 space-x-2">
                    <div class="flex gap-4 h-full">
                        <a href="/detailulasan" class="edit-button font-medium text-blue-600 dark:text-blue-500 hover:underline">
